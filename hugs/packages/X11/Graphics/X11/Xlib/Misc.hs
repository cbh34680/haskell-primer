...
{-# LINE 171 "Graphics/X11/Xlib/Misc.hsc" #-}


{-# LINE 173 "Graphics/X11/Xlib/Misc.hsc" #-}
...
{-# LINE 446 "Graphics/X11/Xlib/Misc.hsc" #-}
	deriving (Eq, Ord, Show)

{-# LINE 448 "Graphics/X11/Xlib/Misc.hsc" #-}
...
{-# LINE 610 "Graphics/X11/Xlib/Misc.hsc" #-}
...
{-# LINE 617 "Graphics/X11/Xlib/Misc.hsc" #-}
...
{-# LINE 623 "Graphics/X11/Xlib/Misc.hsc" #-}
...
noSymbol :: KeySym
noSymbol = 0
{-# LINE 787 "Graphics/X11/Xlib/Misc.hsc" #-}

newtype XComposeStatus = XComposeStatus (Ptr XComposeStatus)

{-# LINE 792 "Graphics/X11/Xlib/Misc.hsc" #-}
	deriving (Eq, Ord, Show)

{-# LINE 794 "Graphics/X11/Xlib/Misc.hsc" #-}
...
{-# LINE 1178 "Graphics/X11/Xlib/Misc.hsc" #-}
	deriving (Eq, Ord, Show)

{-# LINE 1180 "Graphics/X11/Xlib/Misc.hsc" #-}
...
{-# LINE 1187 "Graphics/X11/Xlib/Misc.hsc" #-}
	(\hsc_ptr -> pokeByteOff hsc_ptr 8) text_prop sTRING
{-# LINE 1188 "Graphics/X11/Xlib/Misc.hsc" #-}
	(\hsc_ptr -> pokeByteOff hsc_ptr 16) text_prop (8::Int)
{-# LINE 1189 "Graphics/X11/Xlib/Misc.hsc" #-}
	(\hsc_ptr -> pokeByteOff hsc_ptr 24) text_prop (fromIntegral value_len::Word32)
{-# LINE 1190 "Graphics/X11/Xlib/Misc.hsc" #-}
