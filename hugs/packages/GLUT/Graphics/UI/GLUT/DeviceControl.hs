...
foreign import ccall unsafe "glutSetKeyRepeat" glutSetKeyRepeat ::
   CInt -> IO ()
...
foreign import ccall unsafe "glutIgnoreKeyRepeat" glutIgnoreKeyRepeat ::
   CInt -> IO ()
...
foreign import ccall unsafe "glutForceJoystickFunc" forceJoystickCallback ::
   IO ()
