...
foreign import ccall unsafe "dynamic" dyn_glutCloseFunc :: Graphics.UI.GLUT.Extensions.Invoker (FunPtr CloseCallback -> IO ()) ; glutCloseFunc :: (FunPtr CloseCallback -> IO ()) ; glutCloseFunc = dyn_glutCloseFunc ptr_glutCloseFunc ; ptr_glutCloseFunc :: FunPtr a ; ptr_glutCloseFunc = unsafePerformIO (Graphics.UI.GLUT.Extensions.getProcAddress ("freeglut") ("glutCloseFunc")) ; {-# NOINLINE ptr_glutCloseFunc #-}
...
foreign import ccall unsafe "glutJoystickFunc" glutJoystickFunc ::
